...
export default function Categorias() {
    ...
    return (
        <SafeAreaView style={styles.container}>
            <Text style={styles.title}>Página de Categorias</Text>

            <TouchableOpacity style={styles.btnAdd} onPress={() => { }}>
                <Text style={styles.btnTextAdd}>+ Nova Categoria</Text>
            </TouchableOpacity>
            ...
            <ScrollView style={{ width: '100%', marginTop: 15 }}>
                <View style={styles.card}>
                    <View>
                        ...
                        <Text style={styles.cardSubtitle}>Produtos de tecnologia</Text>
                    </View>
                ...
                <View style={styles.card}>
                    <View>
                        <Text style={styles.cardTitle}>Vestuário</Text>
                        <Text style={styles.cardSubtitle}>Roupas e calçados</Text>
                    </View>
                    <View style={styles.actions}>
                        <TouchableOpacity style={styles.btnEdit} onPress={() => { }}>
                            <Text style={styles.btnTextAction}>Editar</Text>
            ...
            <View style={styles.footerNav}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('Fornecedores')} style={styles.button}>
