...
export default function Categorias() {
  ...
  async function handleSalvar() {
    ...
    try {
      if (editando) {
        const res = await fetch(`${API_BASE_URL}/categorias/${editando.idCategoria}`, {
          method: 'PUT',
  ...
  async function excluir(id: number) {
    try {
      ...
      Alert.alert('Erro', 'Não foi possível excluir. Verifique se há produtos vinculados.');
    }
  }
      ...
      <View style={styles.card}>
        ...
        <View style={{ flex: 1 }}>
          ...
          {item.totalProdutos !== undefined && (
            <Text style={styles.cardSub}>{item.totalProdutos} produtos vinculados</Text>
          )}
        </View>
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.topbar}>
        ...
        <Text style={styles.topbarTitle}>🏷️ Categorias</Text>
        <View style={{ width: 28 }} />
      </View>
      ...
      <View style={styles.footerNav}>
        ...
        <TouchableOpacity style={styles.navBtn} onPress={() => navigation.navigate('Fornecedores')}>
          <Text style={styles.navBtnText}>🚚 Fornecedores</Text>
        </TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  ...
  btnEdit: {
    backgroundColor: COLORS.c3, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 6,
  },
  btnDelete: {
    backgroundColor: COLORS.red, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 6,
  },
  ...
  modalBox: {
    ...
    paddingHorizontal: 18, paddingTop: 12, maxHeight: '60%',
  },
  modalHandle: {
